...
def larger_model():
	...
	# create model
    model = Sequential()
    model.add(Dense(64, input_dim=colCount, kernel_initializer='normal', activation='relu', kernel_regularizer=regularizers.l2(regval)))
    # model.add(Dense(18, kernel_initializer='normal', activation='elu'))
    # model.add(Dense(6, kernel_initializer='normal', activation='relu', kernel_regularizer=regularizers.l2(0.005), activity_regularizer=regularizers.l1(0.005)))
    # model.add(Dense(6, kernel_initializer='normal', activation='relu', kernel_regularizer=regularizers.l2(0.005), activity_regularizer=regularizers.l1(0.005)))
    # model.add(Dense(6, kernel_initializer='normal', activation='relu', kernel_regularizer=regularizers.l2(0.005), activity_regularizer=regularizers.l1(0.005)))
    # model.add(Dense(6, kernel_initializer='normal', activation='relu', kernel_regularizer=regularizers.l2(0.005), activity_regularizer=regularizers.l1(0.005)))
    #model.add(BatchNormalization())
    model.add(Dense(128, kernel_initializer='normal', activation='relu', kernel_regularizer=regularizers.l2(regval)))
    #model.add(BatchNormalization())
    model.add(Dense(128, kernel_initializer='normal', activation='relu', kernel_regularizer=regularizers.l2(regval)))
    #model.add(BatchNormalization())
    model.add(Dense(128, kernel_initializer='normal', activation='relu', kernel_regularizer=regularizers.l2(regval)))
    # model.add(BatchNormalization())
    # model.add(Dense(colCount + 8, kernel_initializer='normal', activation='relu'))
    # model.add(BatchNormalization())
    # model.add(Dense(colCount + 2, kernel_initializer='normal', activation='relu'))
    #model.add(BatchNormalization())
...
if __name__ == "__main__":
    ...
    res = pandas.DataFrame(list(zip(pandas.read_csv("2.csv")['TestIndex'].values, prediction)))
