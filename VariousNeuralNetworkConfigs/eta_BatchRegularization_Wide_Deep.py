...
def larger_model():
	...
	# create model
    model = Sequential()
    model.add(Dense(64, input_dim=colCount, kernel_initializer='normal', activation='relu'))
...
if __name__ == "__main__":
    ...
    # load dataset
    dataframe = pandas.read_csv(f'1_{ds}.csv')
    ...
    estimators.append(('mlp', KerasRegressor(build_fn=larger_model, epochs=55, batch_size=32, verbose=1, validation_split=0.05, shuffle=True)))
